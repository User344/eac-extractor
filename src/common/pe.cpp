...
std::span< IMAGE_SECTION_HEADER > c_pe::get_sections( size_t& out_count ) const {
    return std::span< IMAGE_SECTION_HEADER >( m_sections, m_nt->FileHeader.NumberOfSections );
}
